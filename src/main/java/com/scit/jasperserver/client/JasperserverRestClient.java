package com.scit.jasperserver.client;
...
/**
 * 
 * @author Cuahutli cmulloa@gruposcit.com
 * 
 */
public final class JasperserverRestClient {
        private final static Logger LOGGER = Logger.getLogger(JasperserverRestClient.class);
...
//                Logger.getLogger(getClass().getName()).log(Level.INFO, "getReportAsFile");
...
//                LOGGER.debug("reportResponse: " + reportResponse);
		// ////////////////////////////////////////////////////////////////////////////////
		// Descargar Reporte
		// ////////////////////////////////////////////////////////////////////////////////
		...
		try {
			...
			destFile = File.createTempFile("report_", "." + reporte.getFormat(), parentDir);
